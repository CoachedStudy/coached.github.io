...
function saveData(){
    ...
    localStorage.setItem('tobeLifeData', JSON.stringify(tobeLifeData));
    
    // Retrieve the object from storage
    var retrievedObject = localStorage.getItem('tobeLifeData');
...
function nextPage(){
    ...
    saveData();
    localStorage.setItem("whereWeAre", "passToBeKnowledge"); 
    return true
}
