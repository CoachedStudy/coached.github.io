...
function saveData(){
  var asisKnowledgeData = asisObject;
  
  //----------------Save the Object----------------------
  // Put the object into storage
  localStorage.setItem('asisKnowledgeData', JSON.stringify(asisKnowledgeData));
...
function nextPage(){
  ...
  saveData();
  localStorage.setItem("whereWeAre", "passAsIsAbilities");  
