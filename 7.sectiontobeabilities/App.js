...
var skillChartData = {
  ...
  datasets: [{
    label: "To Be Abilities & Aptitude",
...
function saveData(){
  var tobeAbilitiesData = asisObject;
  
  //----------------Save the Object----------------------
  // Put the object into storage
  localStorage.setItem('tobeAbilitiesData', JSON.stringify(tobeAbilitiesData));
  
  // Retrieve the object from storage
  var retrievedObject = localStorage.getItem('tobeAbilitiesData');
...
function nextPage(){
  ...
  saveData();
  localStorage.setItem("whereWeAre", "passBetterKnowledge"); 
